...
scoreboard players operation temp_ey int = temp_sz int
...
scoreboard players add temp_ex int 1
scoreboard players add temp_ey int 1
scoreboard players add temp_ez int 1
...
execute store result storage math:io xyz[1] double 1 run scoreboard players operation temp_y int /= temp_s int
execute store result storage math:io xyz[2] double 1 run scoreboard players operation temp_z int %= temp_s int
...
execute store result storage math:io xyz[1] double 1 run scoreboard players operation temp_y int /= temp_s int
execute store result storage math:io xyz[0] double 1 run scoreboard players operation temp_x int %= temp_s int
